...
using TTS_Company.Components.Networking.Components.Classes.TTSTask;
using Unity.Netcode;
using UnityEngine;

namespace TTS_Company.Components.Networking.Components
{
    internal sealed class TTSTask_Speak : TTSTask_Base
    {
        ...
        internal TTSTask_Speak(ulong[] expectedClients, int amountOfTexts)
        {
